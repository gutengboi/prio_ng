...
import 'package:prio_ng/components/backgroundView.dart';
import 'package:prio_ng/screens/homeScreen.dart';
  ...
  Widget firstScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "assets/images/awesome.png"),
            // Container(
  ...
  Widget secondScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "assets/images/second.png"),
            // Container(
            //   width: MediaQuery.of(context).size.width,
            //   height: MediaQuery.of(context).size.height,
  ...
  Widget thirdScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "assets/images/student.png"),
            // Container(
            //   width: MediaQuery.of(context).size.width,
            //   height: MediaQuery.of(context).size.height,
            //   color: AppColors.primary.withOpacity(0.7),
